...
@section('header', 'New Category Protocol')
            ...
            <div class="futuristic-bg p-10 text-white relative">
                ...
                <div class="relative z-10 flex items-center gap-6">
                    <div class="p-4 bg-white/20 backdrop-blur-xl rounded-2xl border border-white/30 animate-pulse">
                        <i class="fa fa-folder-plus text-3xl"></i>
                    </div>
                    <div>
                        <h2 class="text-3xl font-black tracking-tighter">Inisiasi Kategori</h2>
                        <p class="text-white/70 font-bold uppercase text-[10px] tracking-[0.5em] mt-1">Data Schema Entry</p>
                    </div>
                </div>
            </div>

            <div class="p-10">
                <form action="{{ route('kategori.store') }}" method="POST" class="space-y-10">
                    @csrf
                    
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text font-black uppercase text-[10px] tracking-widest opacity-40">Classification Label</span>
                        </label>
                        <div class="relative group">
                            ...
                            <input type="text" name="nama_kategori" placeholder="e.g. Operasional Utama"
