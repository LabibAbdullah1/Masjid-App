...
@section('header', 'Event Initialization')
        ...
        <div class="glass-card rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10">
            ...
            <div class="futuristic-bg p-12 text-white relative">
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    <div class="p-6 bg-white/20 backdrop-blur-xl rounded-[2rem] border border-white/30 animate-bounce">
                        <i class="fa fa-microphone-lines text-4xl"></i>
                    </div>
                    <div>
                        <h2 class="text-4xl font-black tracking-tighter">Penjadwalan Dakwah</h2>
                        <p class="text-white/70 font-bold uppercase text-[10px] tracking-[0.5em] mt-2">Spiritual Broadcast Protocol</p>
                    </div>
                </div>
            </div>

            <div class="p-10 lg:p-16">
                <form action="{{ route('admin.jadwal-ceramah.store') }}" method="POST" class="space-y-12">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text font-black uppercase text-[10px] tracking-widest opacity-40">Keynote Resource</span>
                            </label>
                            <div class="relative group">
                                ...
                                <input type="text" name="penceramah" value="{{ old('penceramah') }}" placeholder="As-Syaikh / Al-Ustadz..."
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Enter talk title..."
                                       class="input input-lg w-full pl-16 bg-base-200/50 border-base-300 focus:border-primary focus:outline-none transition-all font-black text-lg rounded-2xl" 
                                       required />
                            </div>
                        </div>
