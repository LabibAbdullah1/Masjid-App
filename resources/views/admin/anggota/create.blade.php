...
@section('header', 'Registrasi Anggota')
    ...
    <div class="max-w-4xl mx-auto py-8" data-aos="zoom-in">
        <div class="glass-card rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10 group">
            ...
            <div class="futuristic-bg p-12 text-white relative">
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    <div class="p-6 bg-white/20 backdrop-blur-xl rounded-[2rem] border border-white/30 animate-pulse">
                        <i class="fa fa-user-plus text-4xl"></i>
                    </div>
                    <div>
                        <h2 class="text-4xl font-black tracking-tighter">Profil Baru Jamaah</h2>
                        <p class="text-white/70 font-bold uppercase text-[10px] tracking-[0.5em] mt-2">Biometric & Identity Protocol</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-10 lg:p-16">
                {{-- Form Messages --}}
                @if (session('success'))
                    <div class="alert alert-success glass-card text-white mb-10 border-none shadow-xl">
                        <i class="fa-solid fa-circle-check text-2xl"></i>
                        <span class="font-black uppercase text-xs tracking-widest">{{ session('success') }}</span>
                    </div>
                @endif

                <form method="POST" action="{{ route('admin.anggota.store') }}" class="space-y-12">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative group/input">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter full name..."
                                       class="input input-lg w-full pl-16 bg-base-200/50 border-base-300 focus:border-primary focus:outline-none transition-all font-black text-lg rounded-2xl" required autofocus />
                            </div>
                            @error('name')
                                <p class="text-[10px] font-black uppercase text-error mt-2 ml-2 tracking-widest">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative group/input">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" placeholder="jamaah@masjid.com"
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text font-black uppercase text-[10px] tracking-widest opacity-40">Access Encryption Key</span>
                            </label>
                            <div class="relative group/input">
                                <div class="absolute left-6 top-1/2 -translate-y-1/2 text-primary opacity-20 group-focus-within/input:opacity-100 transition-opacity">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text font-black uppercase text-[10px] tracking-widest opacity-40">Verification Key</span>
                            </label>
                            <div class="relative group/input">
                                <div class="absolute left-6 top-1/2 -translate-y-1/2 text-primary opacity-20 group-focus-within/input:opacity-100 transition-opacity">
                                    <i class="fa fa-shield-halved text-lg"></i>
                                </div>
                                <input type="password" name="password_confirmation" placeholder="Repeat access key..."
                                       class="input input-lg w-full pl-16 bg-base-200/50 border-base-300 focus:border-primary focus:outline-none transition-all font-black text-lg rounded-2xl" required />
                            </div>
                        </div>
                    </div>
